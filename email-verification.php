...
if (isset($_POST["verify_email"]))
{
    ...
    $sql = "UPDATE users SET email_verified_at = NOW() WHERE user_email_address = '" . $user_email_address . "' AND verification_code = '" . $verification_code . "'";
      ...
      <h3 class="text-center"  style="color:black; margin-left: 0px;"> THE FITNESS AVE. GYM </h3>
        ...
        <form method="POST">
          <div class="form-group has-feedback"  style="width: 86%; margin-left: 25px;">
            <input type="text" class="form-control" name="verification_code" placeholder="XXXXXX" required>
            <input type="hidden" name="user_email_address" value="<?php echo $_GET['user_email_address']; ?>" required>
        </div>
          
          <div class="row">
          <div class="col-xs-12" style="width: 79%; margin-left: 40px; font-size: 14px;">
          <input type="submit" class="btn btn-primary btn-block btn-flat" name="verify_email" value="Verify Email">
