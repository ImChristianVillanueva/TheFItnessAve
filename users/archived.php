...
<?php
          ...
          $sql = "SELECT * FROM users WHERE delete_status = 1";
          ...
          while ($row = $stmt->fetch()) { ?>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="#delete" data-toggle="modal" data-delete_users_id="<?php echo $row['id'] ?>" class='btn btn-success btn-sm btn-flat delete' 
                              ><i class="fa fa-trash-restore"></i> Restore</a>
                            </td>
                          </tr>
...
<!-- ./wrapper -->
<?php include 'modal/archivedmodal.php'; ?>
