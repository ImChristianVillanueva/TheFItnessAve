...
.line div:nth-child(2){
  ...
  <div class="container-fluid" style="background-color: #000; border-bottom: 1px solid gray;">
    ...
    <div class="container mb-5 mt-5 pb-5 pt-5 rooms" style="padding-top: 140px; text-align: center;">
    <section class="banner-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="bs-text">
                        <h2>Upload Membership <br> Payment</h2>
                        <div class = "line">
                          <div></div>
                          <div></div>
                          <div></div>
      ...
      <form method="POST" action="controller/purchaseController.php"  enctype="multipart/form-data">
        <div class="row">
