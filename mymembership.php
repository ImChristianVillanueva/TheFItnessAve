            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT *,p.id AS p_id, p.status AS p_status, i.timein AS i_timein, i.timeout AS i_timeout, p.enddate AS p_enddate FROM purchase p INNER JOIN membershippackages m ON m.id=p.membershippackages_id  
                            ...
                            <tr class="border">
                               ...
                               <td><?php echo $row['i_timein'] ?></td>
                                ...
                                <td>
                                  <?php
                                  if ($row['p_status'] == 1) { ?>
                                    <button class='btn btn-success btn-sm btn-flat makepayment' disabled><i class="fas fa-money"></i> Make Payment</button>
                                  <?php }else { ?>
                                    <a href="uploadmembershippaymentproof.php?p_id=<?php echo $row['p_id'] ?>" class='btn btn-success btn-sm btn-flat makepayment' 
