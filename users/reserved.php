  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Reserved Plan</li>
      </ol>
    </section>
...
<!-- ./wrapper -->
<?php include 'modal/reservedmodal.php'; ?>
