...
<body  class="hold-transition login-page">
    ...
    <div class="login-box" style= "margin-top: -600px; position: absolute; margin-left: 550px;">
  	<div class="login-box-body" style="height:480px; width: 110%; margin-left: 300px; border: 1px solid black; border-radius: 20px; box-shadow: 1px 1px 2px #000000;">
      ...
      <p style="font-size:13px; margin-left: 15px;">Please enter your registered email address. An email notification with a password reset code will then be sent to you.</p>
    	...
    	<form action="controller/forgotpasswordController.php" method="POST">
      		<div class="form-group has-feedback"  style="width: 90%; margin-top: 20px; margin-left: 15px;">
        		<input type="email" class="form-control" name="user_email_address" placeholder="Enter registered email" required>
        		<span class="fa fa-envelope" style="float:left; margin-top: -26px; margin-left: 290px; font-weight: 600;"></span>
      		</div>
      		<div class="row">
    			<div class="col-xs-12" style="width: 83%; margin-left: 30px; margin-top: 20px; font-size: 14px;">
          ...
          <div style="margin-left: 297px; margin-top: -23.7px;">
