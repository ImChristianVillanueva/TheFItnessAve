...
<html lang="en">
  ...
  <div class="container-fluid" style="padding-top: 140px; text-align: center;">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="bs-text">
                      ...
                      <p class="text" style="color: white;"> Choose your reservation plan</p>
                    </div>
                </div>
            </div>
        </div>
		...
		<div class="col-lg-12">
          <div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
           <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-all" role="tab" aria-controls="v-pills-all" aria-selected="true" >All</a>
            <a class="nav-link" id="v-pills-premium-tab" data-toggle="pill" href="#v-pills-premium" role="tab" aria-controls="v-pills-profile" aria-selected="false">Premium</a>
            <a class="nav-link" id="v-pills-gold-tab" data-toggle="pill" href="#v-pills-gold" role="tab" aria-controls="v-pills-messages" aria-selected="false">Gold</</a>
            <a class="nav-link" id="v-pills-silver-tab" data-toggle="pill" href="#v-pills-silver" role="tab" aria-controls="v-pills-settings" aria-selected="false">Silver</a>
          </div>
...
<?php
            ...
            <div class="tab-pane fade" id="v-pills-premium" role="tabpanel" aria-labelledby="v-pills-premium-tab">
              ...
              <div class="card__container grid">
                <!--==================x`== CARD 1 ====================-->
                <?php
                $sql = "SELECT * FROM membershippackages WHERE enddate > '".date('Y-m-d')."' AND available > 0 AND category='Premium'" ;
                $stmt = $this->conn()->query($sql);
                while ($row = $stmt->fetch()) {
                ?>
                <article class="card__content grid">
                    ...
                    <p style="text-align: center;">Start: <?php echo $row['startdate'] ?></p>
                  <p style="text-align: center;">End: <?php echo $row['enddate'] ?></p>
                  <div>
                    <?php if (isset($_SESSION['id'])) { ?>
                      <a href="availnow2.php?id=<?php echo $row['id'] ?>" class="btn btn-dark form-control">Avail Now!</a>
                    <?php } else { ?>
                      <a href="customerlogin.php" class="btn btn-dark form-control">Avail Now!</a>
                    <?php } ?>
                  </div> 
            ...
            <div class="tab-pane fade" id="v-pills-gold" role="tabpanel" aria-labelledby="v-pills-gold-tab">
              <br><br>
              <div class="card__container grid">
                <!--==================x`== CARD 1 ====================-->
                <?php
                $sql = "SELECT * FROM membershippackages WHERE enddate > '".date('Y-m-d')."' AND available > 0 AND category='Gold'" ;
                $stmt = $this->conn()->query($sql);
                while ($row = $stmt->fetch()) {
                ?>
                <article class="card__content grid">
          ...
          <div class="tab-pane fade" id="v-pills-silver" role="tabpanel" aria-labelledby="v-pills-silver-tab">
          <br><br>
              <div class="card__container grid">
                <!--==================x`== CARD 1 ====================-->
                <?php
                $sql = "SELECT * FROM membershippackages WHERE enddate > '".date('Y-m-d')."' AND available > 0 AND plan='Silver'" ;
                $stmt = $this->conn()->query($sql);
                while ($row = $stmt->fetch()) {
                ?>
                <article class="card__content grid">
