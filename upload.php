...
.line div:nth-child(2){
  ...
  <div class="container-fluid" style="background-color: #000; border-bottom: 1px solid gray;">
    ...
    <form method="POST" action="controller/uploadproofController.php"  enctype="multipart/form-data">
        <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group border p-5" style="height: 600px;">
                    <div class="m-auto bg-white position-relative border" style="width: 300px;height: 100%;">
                      ...
                      <input type="file" name="images" id="proof" accept=".png" class="form-control border-0 h-100 w-100 position-absolute" style="opacity: 0;" required>
                    </div>
              ...
              <div>
              <input type="hidden" name="customers_code" value="<?php echo $_GET['customers_code'] ?>">
