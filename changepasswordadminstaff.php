...
<div class="login-box">
      ...
      <h3 class="text-center"> THE FITNESS AVE. GYM </h3>
    	...
    	<form action="controller/changepasswordadminstaffController.php" method="POST">
        <input type="hidden" name="code" value="<?php echo $_GET['code'] ?>">
          ...
          <div class="form-group has-feedback">
            ...
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      		...
      		<div class="row">
    			<div class="col-xs-12">
          			<button type="submit" class="btn btn-primary btn-block btn-flat" name="changepassword"><i class="fa fa-sign-in"></i> Change Password</button>
        	</div>
          <br>
          <br>
          <br>
