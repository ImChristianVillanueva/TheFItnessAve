    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Reserved Plan</b></h4>
            </div>
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-primary btn-flat" name="add"><i class="fa fa-save"></i> Reserved</button>
              </form>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="makepayment">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="../controller/reservedController.php" enctype="multipart/form-data">
...
<div class="modal fade" id="setplan">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Set Plan</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="../controller/reservedController.php" enctype="multipart/form-data">
                <h3 for="plan" class="bg-success control-h3" style="padding: 5px;">Reserved Plan Set To Purchase Plan</label>
                  <input type="hidden" id="r_id" name="r_id">
                </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
              <button type="submit" class="btn btn-primary btn-flat" name="setplan"><i class="fa fa-save"></i> Save</button>
              </form>
            </div>
        </div>
    </div>
